...
namespace Catalog.Infrastructure.Data
{
    public class CatalogContext : ICatalogContext
    {
        ...
        public CatalogContext(IConfiguration configuration)
        {
            ...
            Products = database.GetCollection<Product>(configuration.GetValue<string>("DatabaseSettings:CollectionName"));// Product is the main collection, so named it as collectinsname
